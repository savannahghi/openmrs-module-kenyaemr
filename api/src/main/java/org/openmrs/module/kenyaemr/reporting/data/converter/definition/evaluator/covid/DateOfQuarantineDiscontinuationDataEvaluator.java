 ...
 */
@Handler(supports= DateOfQuarantineDiscontinuationDataDefinition.class, order=50)
public class DateOfQuarantineDiscontinuationDataEvaluator implements PersonDataEvaluator {

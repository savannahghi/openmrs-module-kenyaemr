...
public class NumberNotContactedTodayDataEvaluator implements PersonDataEvaluator {
    ...
    public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select c.patient_related_to,count(c.id) from openmrs.kenyaemr_hiv_testing_patient_contact c left join openmrs.kenyaemr_hiv_testing_client_trace t\n" +

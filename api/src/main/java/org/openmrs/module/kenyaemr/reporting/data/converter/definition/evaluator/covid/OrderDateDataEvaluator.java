...
/**
 * Evaluates a OrderDateDataDefinition
 */
@Handler(supports= OrderDateDataDefinition.class, order=50)
public class OrderDateDataEvaluator implements PersonDataEvaluator {

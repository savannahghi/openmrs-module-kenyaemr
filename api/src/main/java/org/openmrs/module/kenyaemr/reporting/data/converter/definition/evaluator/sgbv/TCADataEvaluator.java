...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.sgbv.TCADataDefinition;
 ...
 */
@Handler(supports= TCADataDefinition.class, order=50)
public class TCADataEvaluator implements PersonDataEvaluator {
    ...
    public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "SELECT a.encounter_id, fup.`next_appointment_date`\n" +

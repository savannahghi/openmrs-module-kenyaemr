...
public class CommonMetadata extends AbstractMetadataBundle {
	...
	public void install() {
		...
		String adxMappingString = "[{\"reportName\":\"COVID-19 Dashboard Indicators\",\"prefix\":\"Y18_\",\"datasets\":[{\"name\":\"2\",\"dhisName\":\"xUesg8lcmDs\"},{\"name\":\"1\",\"dhisName\":\"ptIUGFkE6jn\"},{\"name\":\"3\",\"dhisName\":\"Vo4KDrUFwnA\"}]}]";
		...
		install(patientIdentifierType("Case ID", "Assigned to a Covid-19 Case",
		...
		install(patientIdentifierType("National ID", "Kenyan national identity card number",
				".{1,20}", "At most 20 characters long", null,
		...
		install(patientIdentifierType("Passport Number", "Passport Number",
				null, "At most 14 characters long", null,

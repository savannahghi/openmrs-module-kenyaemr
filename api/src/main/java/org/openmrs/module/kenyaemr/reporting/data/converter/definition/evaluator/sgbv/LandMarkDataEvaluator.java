...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.sgbv.LandMarkDataDefinition;
...
public class LandMarkDataEvaluator implements PersonDataEvaluator {
    ...
    public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "SELECT a.encounter_id, IFNULL(c.`address2`,c.`address5`) AS sublocation_landmark\n" +

...
/**
 * Evaluates a TransferQuarantineFacilityDataDefinition
 */
@Handler(supports= TransferQuarantineFacilityDataDefinition.class, order=50)
public class TransferQuarantineFacilityDataEvaluator implements PersonDataEvaluator {
    ...
    public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select e.patient_id,e.quarantine_center_trf_from from kenyaemr_etl.etl_covid_quarantine_enrolment e;";

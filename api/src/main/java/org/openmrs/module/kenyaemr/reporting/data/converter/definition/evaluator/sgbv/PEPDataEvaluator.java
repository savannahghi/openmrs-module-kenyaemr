 ...
 */
@Handler(supports= PEPDataDefinition.class, order=50)
public class PEPDataEvaluator implements PersonDataEvaluator {
    ...
    public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "SELECT a.encounter_id, IF(pep.action_taken=165171, 'Yes', 'No') given_pep\n" +
                        ...
                        "		WHERE gsa.`action_taken` = 165171) pep ON a.`visit_id` = pep.visit_id";

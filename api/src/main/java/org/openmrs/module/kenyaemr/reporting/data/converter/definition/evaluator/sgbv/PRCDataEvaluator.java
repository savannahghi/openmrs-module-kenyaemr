 ...
 */
@Handler(supports= PRCDataDefinition.class, order=50)
public class PRCDataEvaluator implements PersonDataEvaluator {
    ...
    public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "SELECT a.encounter_id, IF(prc.action_taken=127910, prc.date_created, NULL) prc_fill_date\n" +
                        ...
                        "		WHERE gsa.`action_taken` = 127910 ) prc ON a.`visit_id` = prc.visit_id";

...
/**
 * Evaluates a NameOfQuarantineCenterDataDefinition
 */
@Handler(supports= NameOfQuarantineCenterDataDefinition.class, order=50)
public class NameOfQuarantineCenterDataEvaluator implements PersonDataEvaluator {
    ...
    public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select e.patient_id,e.quarantine_center from kenyaemr_etl.etl_covid_quarantine_enrolment e;";

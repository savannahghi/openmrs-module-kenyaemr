...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.covid.ContactsIdentifiedDataDefinition;
...
/**
 * Evaluates a Contacts Identified DataDefinition
 */
@Handler(supports= ContactsIdentifiedDataDefinition.class, order=50)
public class ContactsIdentifiedDataEvaluator implements PersonDataEvaluator {

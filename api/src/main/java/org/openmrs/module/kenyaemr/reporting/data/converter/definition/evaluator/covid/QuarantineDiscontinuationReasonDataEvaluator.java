...
/**
 * Evaluates a quarantine discontinuation reason
 */
@Handler(supports= QuarantineDiscontinuationReasonDataDefinition.class, order=50)
public class QuarantineDiscontinuationReasonDataEvaluator implements PersonDataEvaluator {

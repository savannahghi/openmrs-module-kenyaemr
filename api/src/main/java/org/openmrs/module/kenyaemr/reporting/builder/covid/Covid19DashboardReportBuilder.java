...
public class Covid19DashboardReportBuilder extends AbstractReportBuilder {
    ...
    protected DataSetDefinition covid19DatasetDefinition() {
        ...
        EmrReportingUtils.addRow(cohortDsd, "Contacts listed", "Contacts listed", ReportUtils.map(covidIndicators.contactsListed(), indParams), covidDisaggregationTotal, Arrays.asList("17"));

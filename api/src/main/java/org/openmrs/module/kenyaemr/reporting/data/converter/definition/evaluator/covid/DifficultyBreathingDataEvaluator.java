...
/**
 * Evaluates a DifficultyBreathingDataDefinition
 */
@Handler(supports= DifficultyBreathingDataDefinition.class, order=50)
public class DifficultyBreathingDataEvaluator implements PersonDataEvaluator {

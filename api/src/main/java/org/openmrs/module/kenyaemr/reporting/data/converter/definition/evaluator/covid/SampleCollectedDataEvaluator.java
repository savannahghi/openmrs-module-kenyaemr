...
/**
 * Evaluates a SampleCollectedDataDefinition
 */
@Handler(supports= SampleCollectedDataDefinition.class, order=50)
public class SampleCollectedDataEvaluator implements PersonDataEvaluator {

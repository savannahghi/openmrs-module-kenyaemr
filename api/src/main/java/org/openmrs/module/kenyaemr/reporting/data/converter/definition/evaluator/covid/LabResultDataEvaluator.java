...
/**
 * Evaluates a LabResultDataDefinition
 */
@Handler(supports= LabResultDataDefinition.class, order=50)
public class LabResultDataEvaluator implements PersonDataEvaluator {

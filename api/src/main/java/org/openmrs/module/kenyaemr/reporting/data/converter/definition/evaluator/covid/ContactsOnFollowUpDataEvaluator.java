...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.covid.ContactsOnFollowUpDataDefinition;
...
/**
 * Evaluates a FeverDataDefinition
 */
@Handler(supports= ContactsOnFollowUpDataDefinition.class, order=50)
public class ContactsOnFollowUpDataEvaluator implements PersonDataEvaluator {
    ...
    public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select f.case_patient,count(f.patient_id)\n" +
                ...
                "     ) f where (selfQ is not null and datediff(curdate(),first_self_q_followup_date) < 14) or (govQ is not null and datediff(curdate(), first_gov_quarantine_date) < 14) group by f.case_patient;";

<%
	...
	def menuItems = [
			[ label: "Back to previous step", iconProvider: "kenyaui", icon: "buttons/back.png", href: ui.pageLink("kenyaemr", "surveillance/surveillanceHome") ]
	]
%>
<div class="ke-page-sidebar">
	...
	<div class="ke-panel-frame" id="ng-similarpatients" ng-controller="SimilarPatients" ng-init="init('${ currentApp.id }', 'kenyaemr', 'registration/registrationViewPatient')">
		...
		<div class="ke-panel-heading">Similar Cases</div>
...
<div class="ke-page-content">
	${ ui.includeFragment("kenyaemr", "patient/editPatient", [ person: person, heading: "Register Case" ]) }
</div>
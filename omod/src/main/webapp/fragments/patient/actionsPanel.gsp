		...
		<ul id = "clinical-tools" class="float-left">
			...
			<li class="float-left" style="margin-top: 7px">
				<a>
					...
					${ ui.includeFragment("kenyaemr", "widget/formLightStack", [ forms: clinicalForms, onFormClick: onCFFormClick ]) }
		...
		<ul id="program-level-tools" class="float-left">
			...
			<li class="float-left" style="margin-top: 7px">
				<a>
					...
					${ ui.includeFragment("kenyaemr", "widget/formLightStack", [ forms: programLevelForms, onFormClick: onPLFormClick ]) }
		...
		<ul id="other-tools" class="float-left">
			...
			<li class="float-left" style="margin-top: 7px">
				<a>
					...
					${ ui.includeFragment("kenyaemr", "widget/formLightStack", [ forms: otherForms, onFormClick: onOtherFormClick ]) }

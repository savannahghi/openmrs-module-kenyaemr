...
public class ContactFollowupHomePageController {
	...
	public String controller(UiUtils ui, PageModel model) {
		...
		if (patient != null) {
			return "redirect:" + ui.pageLink(EmrConstants.MODULE_ID, "covid/contactFollowupViewPatient", SimpleObject.create("patientId", patient.getId()));
		} else {
			return null;
		}
	}

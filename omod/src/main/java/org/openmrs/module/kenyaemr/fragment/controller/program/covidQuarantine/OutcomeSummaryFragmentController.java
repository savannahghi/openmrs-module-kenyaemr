...
public class OutcomeSummaryFragmentController {
	...
	public String controller(@FragmentParam("patientProgram") PatientProgram enrollment,
		...
		String DISCONTINUATION_CONCEPT = "161555AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA";
		...
		if (encounter != null) {
			...
			Obs outcomeObs = wrapper.firstObs(Dictionary.getConcept(DISCONTINUATION_CONCEPT));
			if (outcomeObs != null) {
